document.addEventListener("DOMContentLoaded", () => {
  ...
  const navListRef = document.querySelector(".j-navigation-list");
  const headerRef = document.querySelector(".j-header");
  const navigationRef = document.querySelector(".j-navigation");
